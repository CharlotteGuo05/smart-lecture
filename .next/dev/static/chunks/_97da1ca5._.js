...
function ProfessorChat({ onSeek }) {
    ...
    const handleSend = ()=>{
        ...
        setIsTyping(true);
        setTimeout(()=>{
            const matched = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockResponses"].find((r)=>r.keywords.some((k)=>query.includes(k)));
            const response = matched ? {
                ...matched.response,
                id: `r-${Date.now()}`
            } : {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultResponse"],
                id: `r-${Date.now()}`
            };
            setMessages((prev)=>[
                    ...prev,
...
_s(ProfessorChat, "0Ap/zqqNkHBw8Khhf7EXj2GqZTQ=");
_c = ProfessorChat;
var _c;
...
//# sourceMappingURL=_97da1ca5._.js.map