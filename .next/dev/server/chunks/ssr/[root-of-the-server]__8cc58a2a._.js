...
;
const metadata = {
    title: 'Smart Lecturer - AI-Powered Lecture Analysis',
    description: 'Analyze lecture videos with AI-powered blueprints, interactive flashcards, and knowledge maps.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
